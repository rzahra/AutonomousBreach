function [time_values, valarray] = robustAndPlus_v1(time_values1, valarray1, time_values2, valarray2)
...
for k = 1:length(time_values)
    ...
    idx1 = find(time_values1 <= time_values(k), 1, 'last');
    idx2 = find(time_values2 <= time_values(k), 1, 'last');
